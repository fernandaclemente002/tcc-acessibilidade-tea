...
const ListaHoje = ({ navigation }) => {
    const [lista, setLista] = useState([]);
    const [loading, setLoading] = useState(true);

    const fetchLista = async () => {
        try {
            const response = await axios.get("http://localhost:3000/ListaHoje");
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Todas as listas de Hoje</Text>
            ...
            <View style={styles.content}>
                {loading ? (
                    ...
                    <>
                        <Text style={styles.text}>Nenhuma lista para hoje</Text>
                        <TouchableOpacity
